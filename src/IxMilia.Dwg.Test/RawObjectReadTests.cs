    ...
    public class RawObjectReadTests : AbstractReaderTests
    {
        private static DwgClassDefinition[] CommonClasses()
        {
            return new DwgClassDefinition[]
            {
                ...
                new DwgClassDefinition(0, 0, "", "", "SPATIAL_INDEX", false, false)
            };
        }
        ...
        [Fact]
        public void ReadRawHatch()
        {
            var h = (DwgHatch)ParseRaw(
                new[]
                {
                    null,
                    new DwgClassDefinition(0, 0, "", "", "HATCH", false, false),
                },
                0xE2, 0x00,                                     // length
                0x3D, 0x40, 0x40, 0x5A, 0x26, 0x70, 0x30, 0x00, // data
                                                      // crc
            );
            Assert.Equal(new DwgHandle(0x68), h.Handle);
            Assert.Equal(0.0, h.Elevation);
            Assert.Equal(DwgVector.ZAxis, h.Extrusion);
            Assert.Equal("ANSI31", h.Name);
            Assert.False(h.IsSolidFill);
            Assert.False(h.IsAssociative);
            var n = (DwgHatch.NonPolylineBoundaryPath)h.BoundaryPaths.Single();
            Assert.Equal(4, n.Edges.Count);
            Assert.Equal(new DwgHatch.LineBoundaryPathEdge(new DwgPoint(2.4121491243741104, 2.5147058835855667, 0.0), new DwgPoint(0.6735595277610535, 2.5262148233840307, 0.0)), n.Edges[0]);
            Assert.Equal(new DwgHatch.LineBoundaryPathEdge(new DwgPoint(0.6735595277610535, 2.5262148233840307, 0.0), new DwgPoint(1.6407219550672956, 0.9494884784328512, 0.0)), n.Edges[1]);
            Assert.Equal(new DwgHatch.LineBoundaryPathEdge(new DwgPoint(1.6407219550672956, 0.9494884784328512, 0.0), new DwgPoint(2.193386172357954, 1.2832480678644345, 0.0)), n.Edges[2]);
            Assert.Equal(new DwgHatch.LineBoundaryPathEdge(new DwgPoint(2.193386172357954, 1.2832480678644345, 0.0), new DwgPoint(2.4121491243741104, 2.5147058835855667, 0.0)), n.Edges[3]);
            Assert.Equal(DwgHatchStyle.OddParity, h.HatchStyle);
            Assert.Equal(DwgHatchPatternType.Predefined, h.PatternType);
            Assert.Equal(Math.PI / 2.0, h.PatternAngle);
            Assert.Equal(0.1, h.PatternScale);
            Assert.False(h.IsPatternDoubled);
            var p = h.PatternDefinitionLines.Single();
            Assert.Equal(Math.PI * 0.75, p.Angle);
            Assert.Equal(new DwgPoint(0.0, 0.0, 0.0), p.BasePoint);
            Assert.Equal(new DwgVector(-0.008838834764831846, -0.008838834764831844, 0.0), p.Offset);
            Assert.Empty(p.DashLengths);
            Assert.Equal(1.0, h.PixelSize);
            Assert.Equal(new DwgPoint(0.0, 0.0, 0.0), h.SeedPoints.Single());
        }
        ...
        [Fact]
        public void ReadRawSpatialIndex()
        {
            var s = (DwgSpatialIndex)ParseRaw(
                0x06, 0x04,                                     // length
                0x00, 0x00, 0x80, 0x80, 0x7E, 0x63, 0xA1, 0xF0, // data
                                                      // crc
            );
            Assert.Equal(new DwgHandle(0x01F9), s.Handle);
            Assert.Equal(new DateTime(1997, 12, 2, 10, 1, 44, 940), s.TimeStamp);
            Assert.Equal(980, s.RawData.Length);
            Assert.Equal(0, s.TrailingBitCount);
        }

        [Fact]
        public void ReadRawXRecord()
        {
            var x = (DwgXRecord)ParseRaw(
                0x65, 0x00,                                     // length
                0x3D, 0x00, 0x40, 0x4A, 0x20, 0x80, 0x30, 0x00, // data
                0x04, 0x05, 0x56, 0x01, 0x00, 0x1B, 0x00, 0x0C,
                0x54, 0x68, 0x69, 0x73, 0x20, 0x69, 0x73, 0x20,
                0x61, 0x20, 0x74, 0x65, 0x73, 0x74, 0x20, 0x78,
                0x72, 0x65, 0x63, 0x6F, 0x72, 0x64, 0x20, 0x6C,
                0x69, 0x73, 0x74, 0x0A, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0xF0, 0x3F, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x00, 0x6F,
                0x86, 0x1B, 0xF0, 0xF9, 0x21, 0x09, 0x40, 0x32,
                0x00, 0xD7, 0x35, 0x33, 0xF0, 0xF9, 0x21, 0x09,
                0x40, 0x3E, 0x00, 0x01, 0x00, 0x46, 0x00, 0xB4,
                0x00, 0x40, 0x41, 0x0C, 0x30,
                0x45, 0x76                                      // crc
            );
            Assert.Equal(new DwgHandle(0x28), x.Handle);
            Assert.Equal(86, x.RawXRecordData.Length);
        }
    }
}
