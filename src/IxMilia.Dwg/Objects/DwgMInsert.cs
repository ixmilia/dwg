...
namespace IxMilia.Dwg.Objects
{
    public partial class DwgMInsert
    {
        ...
        public DwgMInsert(DwgBlockHeader blockHeader, IEnumerable<DwgAttribute> attributes)
            : this()
        {
        ...
        public DwgMInsert(DwgBlockHeader blockHeader, params DwgAttribute[] attributes)
